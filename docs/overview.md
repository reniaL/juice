...
当前已经完成 JDK 8、JDK 11、JDK 17 和 JDK 21 的首批内容，包括专题文章和可运行示例。
...
- JDK 17 阅读入口：[jdk-17.md](jdk-17.md)
- JDK 17 代码入口：[../jdk-17-demo/src/main/java/com/juice/jdk17/DemoApplication.java](../jdk-17-demo/src/main/java/com/juice/jdk17/DemoApplication.java)
- JDK 17 运行方式：先执行 mvn -q -pl jdk-17-demo package -DskipTests，再执行 java -cp jdk-17-demo/target/classes com.juice.jdk17.DemoApplication
- JDK 21 阅读入口：[jdk-21.md](jdk-21.md)
- JDK 21 代码入口：[../jdk-21-demo/src/main/java/com/juice/jdk21/DemoApplication.java](../jdk-21-demo/src/main/java/com/juice/jdk21/DemoApplication.java)
- JDK 21 运行方式：先执行 mvn -q -pl jdk-21-demo package -DskipTests，再执行 java -cp jdk-21-demo/target/classes com.juice.jdk21.DemoApplication

## 后续计划

后续会逐步补充：

1. 继续细化 JDK 8、11、17、21 已完成章节中的对照案例和进阶示例
2. 等本机安装 JDK 25 后，再补 JDK 25 的专题正文和首批示例
3. 进一步完善文档与示例代码之间的对应关系说明
